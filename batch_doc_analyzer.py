...
VERSION = 'VERSION = '0.1.1' # requires major.minor.patch notation for auto-increment on commits via make 222' # requires major.minor.patch notation for auto-increment on commits via make 22'
